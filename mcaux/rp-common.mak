...
.PHONY: all latest-tarball versioned-tarball

all: latest-tarball versioned-tarball

latest-tarball: b/archive/mcaux_latest_$(BOARD).tar.gz

versioned-tarball: b/archive/mcaux_latest_$(BOARD).tar.gz
...
b/archive/mcaux_latest_$(BOARD).tar.gz: mcaux
	mkdir -p b/archive
