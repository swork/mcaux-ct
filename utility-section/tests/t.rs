...
cargo utility-section --load-address 0x10222000 --string "S0=A" --string "S1=BB" --string "URL=http://web.local/" --blob 22,Cargo.toml,2 --blob 33,Cargo.toml,2
...
fn strs() {
    ...
    assert_eq!(c.get_value_by_key(b"URL").unwrap(), b"http://web.local/");
}
