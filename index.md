...
instead enjoying countryside tours on weekend afternoons, some camping
trips and intermittent commuting. I'm well-educated in road safety
and techniques and believe I've developed some reliable judgement, but
by total hours in the saddle over a lifetime of sixty-something years
to date I'm a journeyman at best.
...
that way for several hundred thousand miles assuming reasonable
maintenance.
...
remaining space). Plus I'd need several of them, and wasn't impressed
with the multi-gang bar switches I found.

I opted to replace the inner panel with a custom piece to include a
stalk for switches sticking up toward my left hand, and went looking
for lighted-indicator, push-on-push-off button switches to populate
the stalk. What I found either cost $50 apiece and were an inch
across, awkwardly big for the available space, or were too small to
operate through gloves. Momentary-contact switches otherwise meeting
the requirements, though, are plentiful. Observing that fact took this
from a two-afternoon project to several weeks of spare time. The bike
needed to grow a microprocessor, in a weatherproof control box,
switching this equipment with power MOSFETs. And since it could, since
I would already have committed to a microprocessor, I might as well
...
Since I need my spouse to understand why I'm spending so much time on
